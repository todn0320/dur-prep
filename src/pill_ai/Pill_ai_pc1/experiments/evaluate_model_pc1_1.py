...
MODEL_PATH = Path("src/pill_ai/Pill_ai_pc1/models/resnet18_baseline_pc1_1.pt")
LABEL_MAP_PATH = Path("src/pill_ai/Pill_ai_pc1/models/label_map_pc1_1.json")
OUTPUT_DIR = Path("src/pill_ai/Pill_ai_pc1/models/eval_results")
