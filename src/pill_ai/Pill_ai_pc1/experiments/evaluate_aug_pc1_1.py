...
MODEL_PATH = PROJECT_ROOT / "models" / "resnet18_aug_pc1_1.pt"
...
with open(RESULT_DIR / "classification_report_aug_pc1_1.txt", "w", encoding="utf-8") as f:
    f.write(report)
...
cm_df.to_csv(RESULT_DIR / "confusion_matrix_aug_pc1_1.csv")
...
plt.tight_layout()
plt.savefig(RESULT_DIR / "confusion_matrix_aug_pc1_1.png")
plt.show()
...
pred_df.to_csv(RESULT_DIR / "val_predictions_aug_pc1_1.csv", index=False)
