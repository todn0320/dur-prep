...
MODEL_PATH = MODEL_DIR / "resnet18_aug_pc1_1.pt"
LABEL_MAP_PATH = MODEL_DIR / "label_map_aug_pc1_1.json"
...
NUM_EPOCHS = 10
LEARNING_RATE = 1e-4
NUM_WORKERS = 0  # Windows 환경이면 0 추천
