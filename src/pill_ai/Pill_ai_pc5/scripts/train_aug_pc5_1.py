...
def main():
    ...
    # ==========================================
    # 4. PC5 전용 Augmentation 전략 (Heavy Augmentation)
    # ==========================================
    # 다양한 변형을 무작위로 강하게 섞어서 적용합니다.
    train_transform = transforms.Compose([
        # ⚠️ 해결책: 먼저 모든 이미지를 224x224 크기로 맞춥니다.
    ...
    # ⚠️ Validation은 성능의 정확한 측정을 위해 Augmentation을 적용하지 않음 (Baseline과 동일)
    ...
    print(f"\n🎉 학습 완료! PC5 모델이 성공적으로 저장되었습니다: {MODEL_SAVE_PATH}")
