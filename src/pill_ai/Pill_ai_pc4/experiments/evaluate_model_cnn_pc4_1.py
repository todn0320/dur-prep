...
# 1. 경로 설정
# =========================
META_CSV = Path("src/pill_ai/Pill_ai_pc4/data/meta/meta_split.csv")
MODEL_PATH = Path("src/pill_ai/Pill_ai_pc4/models/resnet18_baseline_pc4_1.pt")
LABEL_MAP_PATH = Path("src/pill_ai/Pill_ai_pc4/models/label_map_pc4_1.json")
OUTPUT_DIR = Path("src/pill_ai/Pill_ai_pc4/models/eval_results")
