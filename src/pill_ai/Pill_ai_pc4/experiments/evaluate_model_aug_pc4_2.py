...
with open(RESULT_DIR / "classification_report_aug_pc4_2.txt", "w", encoding="utf-8") as f:
    f.write(report)
...
cm_df.to_csv(RESULT_DIR / "confusion_matrix_aug_pc4_2.csv")
...
plt.tight_layout()
plt.savefig(RESULT_DIR / "confusion_matrix_aug_pc4_2.png")
plt.show()
...
pred_df.to_csv(RESULT_DIR / "val_predictions_aug_pc4_2.csv", index=False)
